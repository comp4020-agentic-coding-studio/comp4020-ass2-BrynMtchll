...
teachers:
  - halvard-emms
spec:
  - you can explain why the classic Dunning-Kruger curve is partly a statistical artefact
  - you can state Agrippa's trilemma and say which horn you take
  - you can explain why fallibilism is not relativism
related:
...
![Three learners with different inductive biases, scored across all 256 possible target labellings of eight binary points. Each learner's accuracy distribution differs, and all three have a mean of exactly 0.5.](../../decks/figures/no-free-lunch.svg)
