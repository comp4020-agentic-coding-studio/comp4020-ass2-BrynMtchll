...
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2027-05-28",
  description:
    "An account of intelligence built from bacteria upward, then turned on " +
    "the reader: what your mind discards in order to work at all, why it " +
    "can't tell you what it discarded, and why every model you hold rests " +
    "on assumptions you didn't choose.",
  tags: ["cognition", "epistemology", "evolution"],
