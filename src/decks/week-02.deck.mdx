...
## The hypothesis predicts a number

If the animal reads *which bin fired hardest* and cannot resolve within a bin,
then its discrimination threshold should be about **one bin wide**.

```
spectral range covered  =  720 − 300  =  420 nm
receptor classes        =  12
bin width               =  420 / 12   =  35 nm
```
...
```
predicted Δλ (one bin)        ≈  35 nm
measured Δλ (Thoen et al.)    ≈  25–30 nm
comparison animals            ≈   1–4 nm
```

**The prediction lands in the right place**, and the comparison animals are an
order of magnitude away from both.

That is a great deal better than the hypothesis merely sounding plausible, and
it is why this is **[C]** rather than **[S]**.

---

## The moral

A story about a mechanism becomes a scientific claim when it **commits to a
number** you can be wrong about.

"It scans like a barcode reader" is a metaphor. "Its threshold should be about
one bin wide" is a prediction, and the prediction can be checked.

Ask this of every mechanism in the remaining ten weeks.
